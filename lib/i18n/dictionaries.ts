  ...
  en: {
    ...
    skills: {
      ...
      groups: [
        ...
        ['backend and database', ['Next.js API Routes / Server Actions', 'Supabase', 'PostgreSQL', 'Prisma', 'authentication', 'REST APIs', 'basic Node.js']],
        ['AI-assisted development', ['Codex', 'ChatGPT', 'Cursor', 'Claude', 'DeepSeek', 'Qwen', 'prompt engineering', 'AI API integration']],
        ['tools and workflow', ['Git', 'GitHub', 'Gitee', 'Vercel', 'GitHub Actions', 'basic Docker', 'README documentation', 'deployment workflow']],
      ],
    },
    projects: {
    ...
    process: {
      ...
      steps: [
        ...
        ['Integrate backend and AI', 'I connect authentication, database, APIs, and AI features such as smart suggestions, AI replies, and bilingual outputs.'],
        ['Test, optimize, and deploy', 'I review the code, test important flows, optimize performance, write documentation, and deploy to Vercel.'],
      ],
    },
    whyMe: {
      eyebrow: 'why hire me',
